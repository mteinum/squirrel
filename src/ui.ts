  ...
  return `<div class="safari">
    ...
    <main class="workspace">
      <section class="park" aria-label="Park exploration">
        ...
        <div class="map-pins" data-pins></div><span class="squirrel-reaction" data-squirrel-reaction aria-hidden="true" hidden></span>
        ${centralPerk()}
        <div class="vision-message" role="status" hidden><strong>SQUIRREL VISION™</strong><span data-vision-count></span></div>
        <article class="featured-squirrel" aria-label="Featured squirrel" hidden><button class="featured-close" data-action="close-featured" aria-label="Close featured squirrel">×</button><div class="featured-illustration">${squirrelArt}<span>FIELD PORTRAIT · ILLUSTRATED</span></div><div class="featured-story" aria-live="polite"><p class="eyebrow">FEATURED SQUIRREL</p><h2 data-nickname></h2><p class="featured-behaviours" data-featured-behaviours></p><p class="featured-note" data-featured-note></p><small>A playful field nickname</small></div><dl class="featured-facts" data-featured-facts></dl><button class="featured-details text-button" data-view="observation">Open field observation ${icon("arrow")}</button></article>
